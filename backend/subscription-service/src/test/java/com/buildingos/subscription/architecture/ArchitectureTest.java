package com.buildingos.subscription.architecture;
...
@AnalyzeClasses(packages = "com.buildingos.subscription", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    private static final String ROOT = "com.buildingos.subscription";
