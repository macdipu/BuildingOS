package com.buildingos.auth.auth.infrastructure.persistence.mapper;
 ...
 * {@link com.buildingos.auth.auth.domain.model.User} is assembled from (one user row plus its role rows).
 */
