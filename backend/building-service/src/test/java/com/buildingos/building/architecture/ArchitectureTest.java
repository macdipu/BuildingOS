package com.buildingos.building.architecture;
...
@AnalyzeClasses(packages = "com.buildingos.building", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    private static final String ROOT = "com.buildingos.building";
