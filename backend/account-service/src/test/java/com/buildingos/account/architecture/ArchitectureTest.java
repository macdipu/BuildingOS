package com.buildingos.account.architecture;
...
@AnalyzeClasses(packages = "com.buildingos.account", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    private static final String ROOT = "com.buildingos.account";
