package com.buildingos.backoffice.architecture;
...
@AnalyzeClasses(packages = "com.buildingos.backoffice", importOptions = ImportOption.DoNotIncludeTests.class)
class ArchitectureTest {
    private static final String ROOT = "com.buildingos.backoffice";
    ...
    @ArchTest
    static final ArchRule neverDependsOnAuthServiceOrBuildingServiceInternals = noClasses()
            .should().dependOnClassesThat().resideInAnyPackage("com.buildingos.auth..", "com.buildingos.building..",
                    "com.buildingos.subscription..");
