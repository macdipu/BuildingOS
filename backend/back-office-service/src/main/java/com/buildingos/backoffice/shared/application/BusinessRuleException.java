...
public final class BusinessRuleException extends RuntimeException {
    public enum Kind { NOT_FOUND, CONFLICT, UNPROCESSABLE }
    ...
    public static BusinessRuleException unprocessable(String code, String message) {
        return new BusinessRuleException(code, Kind.UNPROCESSABLE, message);
    }
}
