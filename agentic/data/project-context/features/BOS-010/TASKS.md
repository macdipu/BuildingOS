...
| [F4 units & ownership](units-ownership/FEATURE.md) | Carried BOS-002 domain reconciled with F2; [requirements](units-ownership/REQUIREMENTS.md), [decisions](units-ownership/DECISIONS.md), [delivery proposal](units-ownership/DELIVERY-PLAN.md) | COMPLETED 2026-09-25 (local/test); F4-T1..T9 done (F4-T1a..T4b on `RUN-C73FA516545143FAA9B35B168EEFE0C9`/`RUN-0BF1AD24`; F4-T9 QA/REVIEW/RELEASE on `RUN-0C7A44A5EE0743098A534883071D5BB1`, superseding the former after a kit-config change); review READY, QA READY with one documented exclusion (ownership-transfer document upload/download unverified — MinIO's own registry now denies anonymous image pulls on quay.io and Docker Hub, confirmed as an upstream MinIO restriction, not this environment or code), release approved by operator; commits `3ec5219` (ApiClient session-loss-after-login fix, found live during device QA), `32d13c4` |
