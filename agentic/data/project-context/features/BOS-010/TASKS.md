...
| [F4 units & ownership](units-ownership/FEATURE.md) | Carried BOS-002 domain reconciled with F2; [requirements](units-ownership/REQUIREMENTS.md), [decisions](units-ownership/DECISIONS.md), [delivery proposal](units-ownership/DELIVERY-PLAN.md) | Requirements/design approved; IMPLEMENTATION in progress — [F4-T1a](units-ownership/tasks/F4-T1a.md), [F4-T1b](units-ownership/tasks/F4-T1b.md), [F4-T2](units-ownership/tasks/F4-T2.md), [F4-T3a](units-ownership/tasks/F4-T3a.md) done; run `RUN-C73FA516545143FAA9B35B168EEFE0C9` (replaces cancelled `RUN-0BF1AD24`) |
