...
G2 additions (operator 2026-09-23): approver picks the initial `BUILDING_ADMIN`, applicant pre-filled
(D-12); audited transition rows now, Kafka outbox later (D-13); duplicate signals, document upload,
Flutter submit screen, suspend/reactivate in the first G2 slice (D-14).
