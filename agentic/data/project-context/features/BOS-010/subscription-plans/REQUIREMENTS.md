...
| RV-02 | Feature catalog (code): the §149.16 keys — booleans `maintenance.enabled`, `rent_management.enabled`, `work_orders.enabled`, `reports.pdf_export`, `reports.excel_export`; optional non-negative integers `max_units`, `max_users`, `storage_limit_mb` (absent = unlimited); `support_tier` string. Unknown keys / wrong types → 400. | §149.16, D-16 |
