...
import 'package:customer/core/auth/jwt.dart';
...
class ApiClient {
  ...
  ApiClient(this._config, this._cache, this._url, this._sessionExpiry) {
    _dio = Dio()
      ..interceptors.add(
        PrettyDioLogger(
          requestHeader: true,
  ...
  void removeToken() {
    _token = null;
    _cache.flushAll().then((_) => _sessionExpiry.notifyExpired());
  }
